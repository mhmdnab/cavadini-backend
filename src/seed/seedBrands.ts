...
const brands = [
  ...
  // Newly added watch brands (slots for future products — may have no products yet)
  { name: 'Almanus', slug: 'almanus', categories: ['watches'] },
  { name: 'Alpina', slug: 'alpina', categories: ['watches'] },
  { name: 'Astboerg', slug: 'astboerg', categories: ['watches'] },
  { name: 'Baumier', slug: 'baumier', categories: ['watches'] },
  { name: 'Bulova', slug: 'bulova', categories: ['watches'] },
  { name: 'Casio', slug: 'casio', categories: ['watches'] },
  { name: 'Chenevard', slug: 'chenevard', categories: ['watches'] },
  { name: 'Breil', slug: 'breil', categories: ['watches'] },
  { name: 'Dugena', slug: 'dugena', categories: ['watches'] },
  { name: 'Daniel Khone', slug: 'daniel-khone', categories: ['watches'] },
  { name: 'Danish Design', slug: 'danish-design', categories: ['watches'] },
  { name: 'Frederique Constant', slug: 'frederique-constant', categories: ['watches'] },
  { name: 'Goldpfeil', slug: 'goldpfeil', categories: ['watches'] },
  { name: 'Ludwig Stahl', slug: 'ludwig-stahl', categories: ['watches'] },
  // Strap brands
